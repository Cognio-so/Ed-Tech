                ...
                {message.imageUrls && message.imageUrls.length > 0 && (
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-4 mb-2 sm:mb-4">
                    {message.imageUrls.map((url, idx) => {
                      ...
                      const imageUrl = isBase64 ? url : url;
                      ...
                      return (
                        <div key={idx} className="relative group">
                          <img
                            ...
                            onError={(e) => {
                              ...
                              if (parent) {
                                ...
                                errorDiv.className = 'w-full h-48 bg-muted rounded-lg flex items-center justify-center';
                          ...
                          />
                          {isBase64 && (
                            <div className="absolute top-1.5 sm:top-2 left-1.5 sm:left-2 bg-black/50 text-white text-xs px-2 py-1 rounded">
                              Base64
                            </div>
                          )}
