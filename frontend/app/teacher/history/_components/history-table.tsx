...
import { Eye, Trash2, MoreVertical, MessageSquare, Calendar } from "lucide-react"
...
export function HistoryTable({ conversations, onDelete }: HistoryTableProps) {
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead className="text-primary font-semibold">Messages</TableHead>
          ...
          <TableBody>
            {conversations.length === 0 ? (
              ...
              conversations.map((conversation) => {
                ...
                const formattedDate = new Date(conversation.updatedAt).toLocaleDateString("en-GB", {
                  day: "2-digit",
                  month: "2-digit",
                  year: "numeric",
                  hour: "2-digit",
