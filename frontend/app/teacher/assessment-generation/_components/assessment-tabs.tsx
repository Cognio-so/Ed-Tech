...
export function AssessmentTabs({ initialGrades, initialSubjects }: AssessmentTabsProps) {
  ...
  return (
    <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
      ...
      <TabsContent value="form" className="mt-6">
        <AssessmentForm initialGrades={initialGrades} initialSubjects={initialSubjects} />
      </TabsContent>
